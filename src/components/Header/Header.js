...
class Header extends Component {
  ...
  render() {
    return (
      ...
      <div className={`arrow-container ${ this.state.scrollState}`}>
      <svg className={this.state.scrollState} xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" width="60px" height="60px" viewBox="0 0 960 560" enable-background="new 0 0 960 560">
